...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/libdrs_f-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4710&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libdrs_f-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4710&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libdrs_f-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_64</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4710&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libdrs_f-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `libdrs_f` can be installed with `conda`:
...
```
mamba install libdrs_f
```

It is possible to list all of the versions of `libdrs_f` available on your platform with `conda`:
...
```
mamba search libdrs_f --channel conda-forge
```
...
mamba repoquery search libdrs_f --channel conda-forge

# List packages depending on `libdrs_f`:
mamba repoquery whoneeds libdrs_f --channel conda-forge

# List dependencies of `libdrs_f`:
mamba repoquery depends libdrs_f --channel conda-forge
```
